...
from geometry.geometric import is_left_side_of_line, calculate_angle_on_chord, \
    ...
    calculate_arc_length_on_chord, calculate_tangent_points_of_circles
...
def test_pairs_of_tangent_points_on_circle():
    center1 = Coord(100, 100)
    center2 = Coord(500, 100)
    radius = 100
    assert set(calculate_tangent_points_of_circles(center1, radius, center2, radius)) \
    ...
    radius1 = 300
    radius2 = 100
    result = calculate_tangent_points_of_circles(center1, radius1, center2, radius2)
    ...
    radius1 = 100
    radius2 = 300
    assert set(calculate_tangent_points_of_circles(center1, radius1, center2, radius2)) \
           == set(calculate_tangent_points_of_circles(center2, radius2, center1, radius1))
